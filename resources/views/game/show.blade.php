            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <img id="circle" class="" src="{{asset('img/circle.png')}}" alt="" height="250" width="250">

                        <p id="winner" class="display-1 d-none text-primary"></p>
                    </div>
                    <hr>
                    <div class="text-center">
                        <label class="font-weightbold h5">Your Bet</label>
                        ...
                        <hr>
                        <p class="font-weightbold h5">Ramaining Time</p>
    ...
    Echo.channel('game')
        ...
        .listen('WinnerNumberGenerated', (e) =>{
            ...
            if(bet == winner){
                ...
                resultElement.classList.add('text-dager');
            }
        })
</script>
@endpush
